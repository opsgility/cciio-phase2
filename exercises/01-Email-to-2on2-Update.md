# Exercise 1 — Email Thread → 2-on-2 Update

- **App:** Outlook (or Copilot Chat with the thread pasted in)
- **Time:** 5–10 minutes
- **What you'll do:** Turn a long email thread into a clean 5-bullet status update for a 2-on-2 with your manager.
- **Why it matters:** This is 2–4 hours/week of status-writing for many people. Copilot drafts it in seconds.
...
```
Summarize this email thread into 5 bullets for my 2-on-2 with my manager.
Include:
- Key decisions made
- Open action items (with owner if named)
- Status of the project/task
- Any risks or blockers
- Next steps

Use a professional tone suitable for a PM status update.
```
...
- *"Add a confidence level (high/medium/low) for each item."*
- *"Draft a follow-up email to my manager using these points."*
...
## Reflect
- How close was Copilot's summary to what you'd write?
- Would you use this in your real workflow?

*Mirror of `01-Email-Summarization-2on2.md` in github.com/opsgility/CMD-CCIIO.*
